...
export interface EnemyDef {
  ...
  /** `look: 'seed'`: a thrown seed pod trailing spore smoke (`trail` is the smoke's colour) instead of a glowing bolt */
  projectile?: { speed: number; radius: number; color: number; trail?: number; glow?: number; core?: number; look?: 'seed' };
