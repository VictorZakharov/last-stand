...
const CACHE = 'last-stand-4c48ee3a12bd';
const FONTS = 'last-stand-fonts';
const FILES = ["./","./apple-touch-icon.png","./assets/CapePhysicsWorker-BI9waX2Z.js","./assets/index-BUbyB0_4.js","./assets/index-BVNSCfh6.css","./assets/nostr-C4hmC5-m.js","./assets/pbr.worker-DkNTMiNQ.js","./assets/three-DkllKPK_.js","./favicon.svg","./icon-192.png","./icon-512.png","./icon.svg","./index.html","./manifest.webmanifest"];
