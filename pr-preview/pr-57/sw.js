...
const CACHE = 'last-stand-b9e720b6cc4e';
const FONTS = 'last-stand-fonts';
const FILES = ["./","./apple-touch-icon.png","./assets/CapePhysicsWorker-BI9waX2Z.js","./assets/index-CSdY1-z1.js","./assets/index-D2ZxDMZt.css","./assets/three-gQDWbOaO.js","./favicon.svg","./icon-192.png","./icon-512.png","./icon.svg","./index.html","./manifest.webmanifest"];
