...
const CACHE = 'last-stand-2d16ea32d6f0';
const FONTS = 'last-stand-fonts';
const FILES = ["./","./apple-touch-icon.png","./assets/CapePhysicsWorker-BI9waX2Z.js","./assets/index-DxhqE6pI.js","./assets/index-DxlJauYy.css","./assets/nostr-C4hmC5-m.js","./assets/pbr.worker-QRb_HYK5.js","./assets/three-DkllKPK_.js","./favicon.svg","./icon-192.png","./icon-512.png","./icon.svg","./index.html","./manifest.webmanifest"];
