...
const CACHE = 'last-stand-8964acc71eea';
const FONTS = 'last-stand-fonts';
const FILES = ["./","./apple-touch-icon.png","./assets/CapePhysicsWorker-BI9waX2Z.js","./assets/index-DlVG_p7q.css","./assets/index-QrSNJMtC.js","./assets/nostr-C4hmC5-m.js","./assets/pbr.worker-QRb_HYK5.js","./assets/three-DkllKPK_.js","./favicon.svg","./icon-192.png","./icon-512.png","./icon.svg","./index.html","./manifest.webmanifest"];
